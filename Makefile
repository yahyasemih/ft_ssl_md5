...
#    Updated: 2022/05/04 07:09:12 by yez-zain         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_ssl.c ft_ssl_utils.c libc_utils.c main.c md5_utils.c md5.c sha256.c\
	sha256_functions.c sha256_stream.c sha224_stream.c sha224.c
DEPS = md5.h libc_utils.h ft_ssl.h sha224.h sha256.h sha256_functions.h
OBJECTS = $(SRCS:.c=.o)
RED = \033[1;31m
GREEN = \033[1;32m
BLUE = \033[1;34m
